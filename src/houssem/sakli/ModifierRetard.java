 ...
 * @author sakli
 */
public class ModifierRetard extends javax.swing.JFrame {
    ...
    int yMouse;
    Navigateur nn;
    public ModifierRetard(Navigateur n){
        nn=n;
        initComponents();
        seticon();
        ...
        public void modifretard() throws SQLException, ClassNotFoundException
    {   
        ...
        String idc=(String) jTable2.getModel().getValueAt(index2, 0);
        ...
        if (jRadioButtonANon.isSelected())
            autoc="Non";
        String requete = "UPDATE retards SET type='"+typec+"', dateabs='"+datec.toString()+"', heuredb='"+heuredbc.toString()+"', duree='"+dureec.toString()+"', motif='"+motifc+"', justificatif='"+justc+"', autorise='"+autoc+"' WHERE id='"+idc+"'";
        ...
        {
            if (bdretards.get(i).id.equals(idc))
                bdretards.set(index2, rt);
        }
        
        DefaultTableModel model3 = (DefaultTableModel) jTable2.getModel();
        model3.setValueAt(idc, index2, 0);
        model3.setValueAt(typec, index2, 1);
        model3.setValueAt(datec, index2, 2);
        model3.setValueAt(heuredbc, index2, 3);
        model3.setValueAt(dureec, index2, 4);
        model3.setValueAt(motifc, index2, 5);
        model3.setValueAt(justc, index2, 6);
        model3.setValueAt(autoc, index2, 7);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modif. Fiche R/A");
        ...
        int index11=jTable2.getSelectedRow();
        String valueauto2=(String) jTable2.getModel().getValueAt(index11, 7);
        if (valueauto2.equals("Non"))
        jRadioButtonANon.setSelected(true);
        ...
        int index10=jTable2.getSelectedRow();
        String valueauto=(String) jTable2.getModel().getValueAt(index10, 7);
        if (valueauto.equals("Oui"))
        jRadioButtonAOui.setSelected(true);
        ...
        int index9=jTable2.getSelectedRow();
        String valuejust2=(String) jTable2.getModel().getValueAt(index9, 6);
        if (valuejust2.equals("Non"))
        jRadioButtonJNon.setSelected(true);
        ...
        int index8=jTable2.getSelectedRow();
        String valuejust=(String) jTable2.getModel().getValueAt(index8, 6);
        if (valuejust.equals("Oui"))
        jRadioButtonJOui.setSelected(true);
        ...
        int index7=jTable2.getSelectedRow();
        String valuemotif=(String) jTable2.getModel().getValueAt(index7, 5);
        int k,indexitem=0,taillecombo=jComboBoxMotif.getItemCount();
        for(k=0;k<taillecombo;k++)
        {
            if (valuemotif.equals(jComboBoxMotif.getItemAt(k)))
            indexitem=k;
        }
        jComboBoxMotif.setSelectedIndex(indexitem);
        ...
        int index4=jTable2.getSelectedRow();
        String valuetype=(String) jTable2.getModel().getValueAt(index4, 1);
        if (valuetype.equals("Absence"))
        jRadioButtonabsence.setSelected(true);
        ...
        int index20=jTable2.getSelectedRow();
        String valuetype2=(String) jTable2.getModel().getValueAt(index20, 1);
        if (valuetype2.equals("Retard"))
        jRadioButtonretard.setSelected(true);
    ...
    int index5=jTable2.getSelectedRow();
    Date valuedate=(Date) jTable2.getModel().getValueAt(index5, 2);
    Calendar cal2=Calendar.getInstance();
    cal2.setTime(valuedate);

    dateChooserCombo1.setSelectedDate(cal2);
    ...
    int index18=jTable2.getSelectedRow();
    Time valueminutedur=(Time)jTable2.getModel().getValueAt(index18, 4);
    dureemn.setValue(valueminutedur.getMinutes());
    ...
    int index17=jTable2.getSelectedRow();
    Time valueheuredur=(Time)jTable2.getModel().getValueAt(index17, 4);
    dureehr.setValue(valueheuredur.getHours());
    ...
    int index16=jTable2.getSelectedRow();
    Time valueminutedb=(Time)jTable2.getModel().getValueAt(index16, 3);
    minutedb.setValue(valueminutedb.getMinutes());
    ...
    int index6=jTable2.getSelectedRow();
    Time valueheuredb=(Time)jTable2.getModel().getValueAt(index6, 3);
    heuredb.setValue(valueheuredb.getHours());
    ...
    private void modifierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_modifierMouseClicked
        try {
            ...
            {
                modifretard();
                JOptionPane pane = new JOptionPane("Fiche modifiée avec succès !");
            ...
            Logger.getLogger(ModifierRetard.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifierRetard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

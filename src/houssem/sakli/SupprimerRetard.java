 ...
 * @author sakli
 */
public class SupprimerRetard extends javax.swing.JFrame {
    ...
    int yMouse;
    Navigateur nn;
    public SupprimerRetard(Navigateur n){
        nn=n;
        initComponents();
        seticon();
    ...
    {   
        ...
        String value=(String) jTable2.getModel().getValueAt(index, 0);
        String requete = "DELETE FROM retards WHERE id='"+value+"'";
        stmt = c.prepareStatement(requete);
        stmt.execute();
        int i;
        for(i=0;i<bdretards.size();i++)
        {
            if (bdretards.get(i).id.equals(value))
                bdretards.remove(i);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Suppression Fiche R/A");
        ...
        jLabel10.setText("Voulez vous vraimant supprimer cette fiche ?");
    ...
    private void ouiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ouiMouseClicked
        try {
            ...
            Logger.getLogger(SupprimerRetard.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SupprimerRetard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

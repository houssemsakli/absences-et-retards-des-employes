 ...
 * @author sakli
 */
public class SupprimerAgent extends javax.swing.JFrame {
    ...
    int yMouse;
    Navigateur nn;
    public SupprimerAgent(Navigateur n){
        nn=n;
        initComponents();
        seticon();
    ...
    private void seticon(){
     ...
     setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/houssem/sakli/Icons/Fasttracker.png")));
        ...
        public void suppressionagent() throws SQLException, ClassNotFoundException
    {   
        ...
        String value=(String) jTable5.getModel().getValueAt(index, 0);
        String requete = "UPDATE comptesinscrits SET nomentreprise=null WHERE email='"+value+"'";
        ...
        {
            if (bdcomptes.get(i).email.equals(value))
            {
                cp=bdcomptes.get(i);
            }    
        }
        Comptes cn=new Comptes(cp.email,cp.nom,cp.prenom,cp.genre,cp.mdp,cp.fonction,null);
        for(i=0;i<bdcomptes.size();i++)
        {
            if (bdcomptes.get(i).email.equals(value))
            {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Suppression Agent");
        ...
        jLabel10.setText("Voulez vous vraimant supprimer cet Agent ?");
    ...
    private void ouiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ouiMouseClicked
        try {
            ...
            Logger.getLogger(SupprimerAgent.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SupprimerAgent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
import static houssem.sakli.NavigateurAgent.jTable9;

/**
 *
 * @author sakli
 */
public class AjoutRetardA extends javax.swing.JFrame {
    ...
    int yMouse;
    NavigateurAgent nn;
    public AjoutRetardA(NavigateurAgent n){
        nn=n;
        initComponents();
        seticon();
    ...
    {   
        ...
        String matc=(String) jTable8.getModel().getValueAt(index, 0);
        String typec=null;
        ...
        int nbr =(Integer) jTable8.getModel().getValueAt(index, 4);
        nbr++;
        String nbr2=Integer.toString(nbr);
        DefaultTableModel modelt1 = (DefaultTableModel) jTable8.getModel();
    ...
    private void ajouterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ajouterMouseClicked
        try {
            ...
            Logger.getLogger(AjoutRetardA.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AjoutRetardA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class Navigateur extends javax.swing.JFrame {
    ...
    public static void affichetableretards()
    {
        try{
                ...
                String value2=(String) jTable1.getModel().getValueAt(index2, 0);
    ...
    public void calculemploye()
    {
        ...
        for (i=0;i<n;i++)
        {
            String getmat=(String) jTable1.getModel().getValueAt(i, 0);
            nbab=0;
            for (j=0;j<bdretards.size();j++)
            {
    ...
    public static void affichetableagents()
    {
        try{
                int k;
                DefaultTableModel model8 = (DefaultTableModel) jTable5.getModel();
                model8.setRowCount(0);
               
                for (k=0;k<bdcomptes.size();k++)
                {
                    if(cnx.nomentreprise.equals(bdcomptes.get(k).nomentreprise)&&bdcomptes.get(k).fonction.equals("Agent du service"))
                    {
                        model8.addRow(new Object[]{bdcomptes.get(k).email,bdcomptes.get(k).nom,bdcomptes.get(k).prenom});
                    }
                }
                System.out.println("SIZECOMPTES="+bdcomptes.size());
...
//		jLabelTime1.setText(s.format(d));
    ...
    private void initComponents() {
        ...
        modifierfiche = new javax.swing.JLabel();
        modifieremploye = new javax.swing.JLabel();
        supprimerfiche = new javax.swing.JLabel();
        supprimeremploye = new javax.swing.JLabel();
        ...
        ajouteragent = new javax.swing.JLabel();
        supprimeragent = new javax.swing.JLabel();
        ...
        jTable2.setBackground(new java.awt.Color(252, 241, 239));
        jTable2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 0), 2));
        jTable2.setFont(new java.awt.Font("Source Sans Pro", 0, 18)); // NOI18N
        jTable2.getTableHeader().setFont(new java.awt.Font("Source Sans Pro", 1, 18));
        ...
        jTable1.setBackground(new java.awt.Color(252, 241, 239));
        jTable1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 0), 2));
        jTable1.setFont(new java.awt.Font("Source Sans Pro", 0, 18)); // NOI18N
        jTable1.getTableHeader().setFont(new java.awt.Font("Source Sans Pro", 1, 18));
        ...
        jPanel1.add(imprimeremployes, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 230, 150, 50));
        ...
        jPanel1.add(imprimer, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 560, 150, 50));

        modifierfiche.setBackground(new java.awt.Color(0, 153, 204));
        modifierfiche.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 18)); // NOI18N
        modifierfiche.setForeground(new java.awt.Color(102, 0, 102));
        modifierfiche.setIcon(new javax.swing.ImageIcon(getClass().getResource("/houssem/sakli/Icons/update.png"))); // NOI18N
        modifierfiche.setText("Modifier");
        modifierfiche.setToolTipText("");
        modifierfiche.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(51, 51, 0)));
        modifierfiche.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        modifierfiche.setOpaque(true);
        modifierfiche.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                modifierficheMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                modifierficheMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                modifierficheMouseExited(evt);
            }
        });
        jPanel1.add(modifierfiche, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 500, 150, 50));

        modifieremploye.setBackground(new java.awt.Color(0, 153, 204));
        modifieremploye.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 18)); // NOI18N
        modifieremploye.setForeground(new java.awt.Color(102, 0, 102));
        modifieremploye.setIcon(new javax.swing.ImageIcon(getClass().getResource("/houssem/sakli/Icons/update.png"))); // NOI18N
        modifieremploye.setText("Modifier");
        modifieremploye.setToolTipText("");
        modifieremploye.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(51, 51, 0)));
        modifieremploye.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        modifieremploye.setOpaque(true);
        modifieremploye.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                modifieremployeMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                modifieremployeMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                modifieremployeMouseExited(evt);
            }
        });
        jPanel1.add(modifieremploye, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 170, 150, 50));

        supprimerfiche.setBackground(new java.awt.Color(204, 51, 0));
        supprimerfiche.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 16)); // NOI18N
        supprimerfiche.setForeground(new java.awt.Color(255, 255, 0));
        supprimerfiche.setIcon(new javax.swing.ImageIcon(getClass().getResource("/houssem/sakli/Icons/remove.png"))); // NOI18N
        supprimerfiche.setText("Supprimer");
        supprimerfiche.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(51, 51, 0)));
        supprimerfiche.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        supprimerfiche.setOpaque(true);
        supprimerfiche.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                supprimerficheMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                supprimerficheMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                supprimerficheMouseExited(evt);
            }
        });
        jPanel1.add(supprimerfiche, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 440, 150, 50));

        supprimeremploye.setBackground(new java.awt.Color(204, 51, 0));
        supprimeremploye.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 16)); // NOI18N
        supprimeremploye.setForeground(new java.awt.Color(255, 255, 0));
        supprimeremploye.setIcon(new javax.swing.ImageIcon(getClass().getResource("/houssem/sakli/Icons/remove.png"))); // NOI18N
        supprimeremploye.setText("Supprimer");
        supprimeremploye.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(51, 51, 0)));
        supprimeremploye.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        supprimeremploye.setOpaque(true);
        supprimeremploye.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                supprimeremployeMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                supprimeremployeMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                supprimeremployeMouseExited(evt);
            }
        });
        jPanel1.add(supprimeremploye, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 110, 150, 50));
        ...
        jPanel1.add(ajouterfiche, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 380, 150, 50));
        ...
        jPanel1.add(ajouteremploye, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 50, 150, 50));
        ...
        jScrollPane3.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 0), 3, true));
        jScrollPane3.setFont(new java.awt.Font("Source Sans Pro", 0, 18)); // NOI18N

        jTable5.setAutoCreateRowSorter(true);
        jTable5.setBackground(new java.awt.Color(252, 241, 239));
        jTable5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 0), 2));
        jTable5.setFont(new java.awt.Font("Source Sans Pro", 0, 18)); // NOI18N
        jTable5.getTableHeader().setFont(new java.awt.Font("Source Sans Pro", 1, 18));
        ...
        jTable5.setGridColor(new java.awt.Color(102, 102, 0));
        ...
        jPanel4.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 20, 530, 550));

        ajouteragent.setBackground(new java.awt.Color(102, 102, 0));
        ajouteragent.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 18)); // NOI18N
        ajouteragent.setForeground(new java.awt.Color(0, 255, 102));
        ajouteragent.setIcon(new javax.swing.ImageIcon(getClass().getResource("/houssem/sakli/Icons/add.png"))); // NOI18N
        ajouteragent.setText("Ajouter");
        ajouteragent.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(51, 51, 0)));
        ajouteragent.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ajouteragent.setOpaque(true);
        ajouteragent.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ajouteragentMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                ajouteragentMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                ajouteragentMouseExited(evt);
            }
        });
        jPanel4.add(ajouteragent, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 580, 150, 50));

        supprimeragent.setBackground(new java.awt.Color(204, 51, 0));
        supprimeragent.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 16)); // NOI18N
        supprimeragent.setForeground(new java.awt.Color(255, 255, 0));
        supprimeragent.setIcon(new javax.swing.ImageIcon(getClass().getResource("/houssem/sakli/Icons/remove.png"))); // NOI18N
        supprimeragent.setText("Supprimer");
        supprimeragent.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(51, 51, 0)));
        supprimeragent.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        supprimeragent.setOpaque(true);
        supprimeragent.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                supprimeragentMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                supprimeragentMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                supprimeragentMouseExited(evt);
            }
        });
        jPanel4.add(supprimeragent, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 580, 150, 50));
    ...
    private void supprimeragentMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_supprimeragentMouseExited
        supprimeragent.setBackground(new java.awt.Color(204, 51, 0));
        supprimeragent.setForeground(new java.awt.Color(255, 255, 0));
    }//GEN-LAST:event_supprimeragentMouseExited

    private void supprimeragentMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_supprimeragentMouseEntered
        supprimeragent.setBackground(new java.awt.Color(235, 94, 202));
        supprimeragent.setForeground(new java.awt.Color(107, 61, 30));
    }//GEN-LAST:event_supprimeragentMouseEntered

    private void supprimeragentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_supprimeragentMouseClicked
        if (jTable5.getSelectedRow()==-1)
        {
            JOptionPane pane = new JOptionPane("Sélectionner un agent tout d'abord !");
            JDialog d = pane.createDialog(jPanel4, "ERREUR");
            d.setLocationRelativeTo(jPanel4);
            d.setVisible(true);
        }
        else
        {
            SupprimerAgent nvrs = new SupprimerAgent(this);
            this.setEnabled(false);
            nvrs.setVisible(true);
            nvrs.pack();
        }
    }//GEN-LAST:event_supprimeragentMouseClicked

    private void ajouteragentMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ajouteragentMouseExited
        ajouteragent.setBackground(new java.awt.Color(102, 102, 0));
        ajouteragent.setForeground(new java.awt.Color(0, 255, 102));
    }//GEN-LAST:event_ajouteragentMouseExited

    private void ajouteragentMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ajouteragentMouseEntered
        ajouteragent.setBackground(new java.awt.Color(84, 255, 221));
        ajouteragent.setForeground(new java.awt.Color(13, 92, 40));
    }//GEN-LAST:event_ajouteragentMouseEntered

    private void ajouteragentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ajouteragentMouseClicked
        AjoutAgent nv = new AjoutAgent(this);
        this.setEnabled(false);
        nv.setVisible(true);
        nv.pack();
    }//GEN-LAST:event_ajouteragentMouseClicked
    ...
    private void ajouteremployeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ajouteremployeMouseClicked
        ...
        {
            AjoutEmploye nv = new AjoutEmploye(this);
            this.setEnabled(false);
            nv.setVisible(true);
            nv.pack();
        }
    ...
    private void ajouterficheMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ajouterficheMouseClicked
        ...
        {
            AjoutRetard nr = new AjoutRetard(this);
            this.setEnabled(false);
            nr.setVisible(true);
            nr.pack();
        }
    ...
    private void supprimeremployeMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_supprimeremployeMouseExited
        supprimeremploye.setBackground(new java.awt.Color(204, 51, 0));
        supprimeremploye.setForeground(new java.awt.Color(255, 255, 0));
    }//GEN-LAST:event_supprimeremployeMouseExited

    private void supprimeremployeMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_supprimeremployeMouseEntered
        supprimeremploye.setBackground(new java.awt.Color(235, 94, 202));
        supprimeremploye.setForeground(new java.awt.Color(107, 61, 30));
    }//GEN-LAST:event_supprimeremployeMouseEntered

    private void supprimeremployeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_supprimeremployeMouseClicked
        if (jTable1.getSelectedRow()==-1)
        {
            JOptionPane pane = new JOptionPane("Sélectionner un employé tout d'abord !");
            JDialog d = pane.createDialog(jPanel1, "ERREUR");
        ...
        {
            SupprimerEmploye nvs = new SupprimerEmploye(this);
            this.setEnabled(false);
            nvs.setVisible(true);
            nvs.pack();
        }
    }//GEN-LAST:event_supprimeremployeMouseClicked

    private void supprimerficheMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_supprimerficheMouseExited
        supprimerfiche.setBackground(new java.awt.Color(204, 51, 0));
        supprimerfiche.setForeground(new java.awt.Color(255, 255, 0));
    }//GEN-LAST:event_supprimerficheMouseExited

    private void supprimerficheMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_supprimerficheMouseEntered
        supprimerfiche.setBackground(new java.awt.Color(235, 94, 202));
        supprimerfiche.setForeground(new java.awt.Color(107, 61, 30));
    }//GEN-LAST:event_supprimerficheMouseEntered

    private void supprimerficheMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_supprimerficheMouseClicked
        if (jTable2.getSelectedRow()==-1)
        {
            JOptionPane pane = new JOptionPane("Sélectionner une fiche tout d'abord !");
            JDialog d = pane.createDialog(jPanel1, "ERREUR");
            d.setLocationRelativeTo(jPanel1);
            d.setVisible(true);
        }
        ...
        {
            SupprimerRetard nvrs = new SupprimerRetard(this);
            this.setEnabled(false);
            nvrs.setVisible(true);
            nvrs.pack();
        }
    }//GEN-LAST:event_supprimerficheMouseClicked

    private void modifieremployeMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_modifieremployeMouseExited
        modifieremploye.setBackground(new java.awt.Color(0, 153, 204));
        modifieremploye.setForeground(new java.awt.Color(102, 0, 102));
    }//GEN-LAST:event_modifieremployeMouseExited

    private void modifieremployeMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_modifieremployeMouseEntered
        modifieremploye.setBackground(new java.awt.Color(190, 214, 247));
        modifieremploye.setForeground(new java.awt.Color(19, 56, 107));
    }//GEN-LAST:event_modifieremployeMouseEntered

    private void modifieremployeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_modifieremployeMouseClicked
        if (jTable1.getSelectedRow()==-1)
        {
            JOptionPane pane = new JOptionPane("Sélectionner un employé tout d'abord !");
            JDialog d = pane.createDialog(jPanel1, "ERREUR");
        ...
        {
            ModifierEmploye nvm = new ModifierEmploye(this);
            this.setEnabled(false);
            nvm.setVisible(true);
            nvm.pack();
        }
    }//GEN-LAST:event_modifieremployeMouseClicked

    private void modifierficheMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_modifierficheMouseExited
        modifierfiche.setBackground(new java.awt.Color(0, 153, 204));
        modifierfiche.setForeground(new java.awt.Color(102, 0, 102));
    }//GEN-LAST:event_modifierficheMouseExited

    private void modifierficheMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_modifierficheMouseEntered
        modifierfiche.setBackground(new java.awt.Color(190, 214, 247));
        modifierfiche.setForeground(new java.awt.Color(19, 56, 107));
    }//GEN-LAST:event_modifierficheMouseEntered

    private void modifierficheMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_modifierficheMouseClicked
        if (jTable2.getSelectedRow()==-1)
        {
            JOptionPane pane = new JOptionPane("Sélectionner une fiche tout d'abord !");
            JDialog d = pane.createDialog(jPanel1, "ERREUR");
        ...
        {
            ModifierRetard mdfr = new ModifierRetard(this);
            this.setEnabled(false);
            mdfr.setVisible(true);
            mdfr.pack();
        }
    }//GEN-LAST:event_modifierficheMouseClicked
    ...
    private javax.swing.JLabel ajouteragent;
    ...
    private javax.swing.JLabel modifieremploye;
    private javax.swing.JLabel modifierfiche;
    private javax.swing.JTextField nom;
    private javax.swing.JTextField prenom;
    private javax.swing.JLabel supprimeragent;
    private javax.swing.JLabel supprimeremploye;
    private javax.swing.JLabel supprimerfiche;
